...
#------------------------------------ Main ---------------------------------------
class cnbcTechnologySpider(CrawlSpider):
   ...
   for page in range(1, 171):
      start_urls.append("https://www.cnbc.com/technology/?page=" + str(page))
   ...
   def parse_item(self, response):
      ...
      item['reference'] = 'cnbc'
      item['title']     = str(response.xpath('//h1[contains(@class, "title")]//text()').extract()[0])
