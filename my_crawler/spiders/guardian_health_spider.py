...
#------------------------------------ Main ---------------------------------------
class guardianHealthSpider(CrawlSpider):
   name            = "guardian_health"
   user_agent      = "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.1 (KHTML, like Gecko) Chrome/22.0.1207.1 Safari/537.1"
   allowed_domains = ["www.theguardian.com"]
   baseURL1        = "https://www.theguardian.com"
   start_urls      = []
   for page in range(1, 950):
      start_urls.append("https://www.theguardian.com/lifeandstyle/health-and-wellbeing?page=" + str(page))
