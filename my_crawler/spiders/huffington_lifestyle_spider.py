...
#------------------------------------ Main ---------------------------------------
class huffingtonLifeStyleSpider(CrawlSpider):
   name            = "huffington_lifestyle"
   user_agent      = "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.1 (KHTML, like Gecko) Chrome/22.0.1207.1 Safari/537.1"
   allowed_domains = ["www.huffingtonpost.com"]
   baseURL1        = "https://www.huffingtonpost.com"
   start_urls      = []
   for page in range(1, 6):
      start_urls.append("https://www.huffingtonpost.com/section/huffpost-home?page=" + str(page))
